...
export function LocationCard({ location, compact = false }: LocationCardProps) {
  ...
  if (compact) {
    return (
      <Link
        ...
        className="group flex items-center gap-3 rounded-xl border border-slate-200 bg-white px-3 py-2.5 shadow-sm transition-all hover:border-primary/30 active:scale-[0.99] md:active:scale-100"
      >
  ...
  return (
    <Link
      href={`/locations/${location.id}`}
      className="group flex min-w-0 max-w-full gap-3 overflow-hidden rounded-xl border border-slate-200 bg-white p-3 shadow-sm transition-all hover:border-primary/30 hover:shadow-md active:scale-[0.99] md:active:scale-100"
    >
...
export function ItemCard({ item, showLocation = false, onDelete, deleting }: ItemCardProps) {
  return (
    <div className="flex min-w-0 max-w-full items-center gap-2">
      <Link
        href={`/items/${item.id}`}
        className="group flex min-w-0 max-w-full flex-1 gap-3 overflow-hidden rounded-2xl border border-slate-200 bg-white p-3 shadow-sm transition-all hover:border-primary/30 hover:shadow-md active:scale-[0.99] md:active:scale-100"
      >
